...
export const config = {
  ...
  matcher: ["/((?!_next/static|_next/image|favicon.ico|favicon.*\\.png|icon.png|apple-icon.png|apple-touch-icon.png|android-chrome.*\\.png|mstile.*\\.png|browserconfig.xml|site.webmanifest).*)"],
};
