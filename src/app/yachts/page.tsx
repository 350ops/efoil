  ...
  return (
    <Column maxWidth="l" gap="xl" paddingY="12" paddingX="16" horizontal="center" s={{ paddingY: "8", paddingX: "12", gap: "l" }}>
      ...
      <RevealFx translateY="16" delay={0.2} fillWidth>
        ...
        >
          <Heading as="h2" variant="display-strong-m" align="center">
            Ready to Elevate Your Charter?
          </Heading>
          <Text variant="body-default-l" onBackground="neutral-weak" align="center">
            Get in touch to schedule eFoil delivery to your yacht
          </Text>
          <Row gap="16" wrap horizontal="center" fillWidth s={{ direction: "column", gap: "12" }}>
            <Button
              href={`https://wa.me/${whatsappNumber}?text=${encodeURIComponent("Hi, I'd like to arrange eFoil delivery to our yacht.")}`}
              variant="primary"
              size="l"
              weight="strong"
            >
            ...
            <Button
              href="mailto:hello@efoil.rent?subject=Yacht eFoil Delivery Inquiry"
              variant="secondary"
              size="l"
            >
              Send Email
