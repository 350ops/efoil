---
# Brand Voice Plugin Settings — Maldives eFoil Club
company_name: "Maldives eFoil Club"
platforms:
  notion: false
  confluence: false
  google-drive: false
...
## Domain
efoi.rent (also efoil.rent)

## Contact
- Email: hello@efoil.rent
- Instagram: @efoil.maldives
...
2. **Returning visitors / frequent Maldives travelers** — want guaranteed access without ad hoc uncertainty
3. **Airline crew on layover** — short stays, want structured and pre-coordinated access
4. **First-time eFoil riders** — seeking expert-guided discovery with no friction

## Known Brand Materials
- Membership page copy (provided directly)
- Website source code in the efoil folder (content.tsx, blog posts)
...
Competitive landscape: No direct competitors at this membership tier or logistics reach
